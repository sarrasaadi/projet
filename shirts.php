...
<body>
    <div class="page-content">
        <?php
        $stmt = $pdo->query("SELECT * FROM stock where item like '%shirt%' or product_name like '%shirt%'");//like checks 
        //whether the word shirt in the columns item or prouduct_name of the database
        $count = 0;
